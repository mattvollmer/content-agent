const e=require(`./cookie-BtKXrFr6.cjs`);let t=require(`fs/promises`);t=e.__toESM(t);let n=require(`path`);n=e.__toESM(n);let r=require(`module`);r=e.__toESM(r);async function i(e,{outdir:r}={}){r||=await o(e);let i=(0,n.join)(r,`agent.js`),a=l(),s=await a.build({...c,entryPoints:[e],outfile:i,write:!1});if(s.errors.length>0)throw Error(`Failed to build agent!`);let u=s.outputFiles[0];return await(0,t.writeFile)(i,Buffer.from(u.contents),`utf-8`),{outfile:i}}async function a(e){let r=await s(e,`package.json`);if(!r)throw Error(`No package.json found in ${e}`);let i=JSON.parse(await(0,t.readFile)(r,`utf-8`)),a=i.main;if(!a)throw Error(`"main" is not set in ${(0,n.relative)(process.cwd(),r)}. It should be set to the entrypoint of your agent.`);let o=(0,n.join)((0,n.dirname)(r),a),c=await(0,t.stat)(o);if(!c.isFile())throw Error(`${o} is not a file.`);return o}async function o(e){let r=await s(e,`node_modules`);if(!r){let r=await(0,t.stat)(e);return r.isDirectory()?(0,n.join)(e,`.blink`):(0,n.join)((0,n.dirname)(e),`.blink`)}let i=(0,n.join)(r,`.blink`);return await(0,t.mkdir)(i,{recursive:!0}),i}async function s(e,r){let i=e;for(;i!==(0,n.dirname)(i);){let e=(0,n.join)(i,r);try{return await(0,t.stat)(e),e}catch{}i=(0,n.dirname)(i)}}const c={bundle:!0,format:`esm`,platform:`node`,target:`node22`,mainFields:[`module`,`main`],conditions:[`import`,`module`],plugins:[{name:`blink-esm-require-to-import`,setup(e){e.onEnd(t=>{e.initialOptions.format!==`esm`||e.initialOptions.platform!==`node`||t.outputFiles?.forEach(e=>{if(e.path.endsWith(`.js`)||e.path.endsWith(`.mjs`)){let t=Buffer.from(e.contents).toString(`utf-8`),n=new Map,i=RegExp(`\\b__require\\("(${r.builtinModules.join(`|`)})"\\)`,`gm`);if(t=t.replace(i,(e,t)=>{let r=`__import_${t.toUpperCase().replace(/-/g,`_`)}`;return n.set(t,r),r}),n.size>0){let e=Array.from(n.entries()).map(([e,t])=>`import ${t} from "${e}";`).join(`
`);t=e+`
